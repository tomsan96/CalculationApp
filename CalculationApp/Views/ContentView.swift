    ...
    var body: some View {
        VStack {
            InputItemView(
                unit: .tenThousandYen,
                labelName: "初期投資額",
                number: $investmentAsset.initialInvestmentAmountWithTenThousandYen,
                isFocused: $isTextFieldFocused
            )
            InputItemView(
                unit: .tenThousandYen,
                labelName: "毎月の積み立て金額",
                number: $investmentAsset.monthlyInvestmentAmountWithTenThousandYen,
                isFocused: $isTextFieldFocused
            )
            InputItemView(
                unit: .percent,
                labelName: "想定利回り(年率)",
                number: $investmentAsset.annualInterestRatePercent,
                isFocused: $isTextFieldFocused
            )
            InputItemView(
                unit: .years,
                labelName: "積み立て期間",
                number: $investmentAsset.investmentYears,
                isFocused: $isTextFieldFocused
            )
            Button("計算する") {
